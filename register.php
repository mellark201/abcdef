...
<section style="margin-top:70px;">
    <div id="about_us" style="margin-bottom:0">
        <div data-aos="fade-down" data-aos-anchor-placement="top-center"><h1 style="animation:unset;"><span>participate</span> and<br><span>connect</span> with others</h1><br><p style="margin-top:0;font-size:1.6rem;">Register yourself to the events and win amazing prizes alongside having an amazing time at culrav 2022.</p></div>
</section>
<style>
.form{
