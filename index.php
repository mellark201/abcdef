...
<section id="main-banner">
    ...
    <div class="sm-hide" id="sm" style="font-size: xx-large;">
        <span class="sangkury" style="font-weight: lighter;">16</span><span class="nightmare">th - </span><span class="sangkury" style="font-weight: lighter;">18</span><span class="nightmare">th April, </span><span class="sangkury" style="font-weight: lighter;">2022</span>
...
<!-- </div>
    <div id ="heal" class="content"><h3 class="nightmare" style="font-size: xx-large;">Flight Fright Fight</h3><h4>- Culrav</h4></div>
</section> -->
...
<section id="about-culrav">
    ...
    <div class="flex display-style-3" style="margin-top:0">
        ...
        <div class="count" >
            <div class="heading " style="font-size: large;" data-aos="fade-down" data-aos-anchor-placement="bottom-bottom">
                <h3>04.Rocktave</h3>
                <p>Leave the night on and dance to invigorating music of up-and-coming bands such as The Local Train, Spunk, Parvaaz</p>
            </div>
    ...
    <div class="flex display-style-3" style="margin-top:0">
        ...
        <div class="count" >
            <div class="heading " style="font-size: large;" data-aos="fade-down" data-aos-anchor-placement="bottom-bottom">
                <h3>06.Sufi Night</h3>
                <p>Entwine yourself in the soulful sounds of the sufi music with artists such as Nizami Brothers</p>
            </div>
